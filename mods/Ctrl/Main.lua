...
function Main(isReplay)
    ...
    ReUI.Core.Hook("/lua/ui/controls/worldview.lua", "WorldView", function(WorldView --[[@as WorldView]])
        ...
        WorldView.HandleEvent = function(self, event)
            if useCtrlCopy then
                ...
                if event.Type == "ButtonPress" and event.Modifiers.Ctrl and event.Modifiers.Right and
                    not event.Modifiers.Shift then
