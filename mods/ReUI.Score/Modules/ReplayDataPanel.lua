...
local Functions = ReUI.UI.LayoutFunctions
...
local Chechbox = ReUI.Core.Class(AnimatedBorderedCheckBox)
{
...
local CheckboxDropDown = ReUI.Core.Class(ExpandableSelectionGroup)
{
...
---@class DataPanel : ReUI.UI.Controls.Group
---@field _bg ReUI.UI.Controls.Bitmap
---@field _replayId ReUI.UI.Controls.Text
DataPanel = ReUI.Core.Class(Group)
{
