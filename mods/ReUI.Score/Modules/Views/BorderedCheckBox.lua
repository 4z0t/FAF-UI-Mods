...
local colorAnimationFactory = ReUI.UI.Animation.Factory.Color

---@class BorderedCheckBox : BorderedText
BorderedCheckBox = ReUI.Core.Class(BorderedText)
{
...
local colorAnimator = ReUI.UI.Animation.Animator(GetFrame(0))
local colorAnimation = colorAnimationFactory
    :For(0.3)
    :Create(colorAnimator)

---@class AnimatedBorderedCheckBox : BorderedCheckBox
AnimatedBorderedCheckBox = ReUI.Core.Class(BorderedCheckBox)
{
    OnStateChange = function(self)
