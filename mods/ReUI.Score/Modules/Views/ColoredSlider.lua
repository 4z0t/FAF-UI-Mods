...
ColoredSlider = ReUI.Core.Class(Group)
{
        ...
        if self._isVertical then
            ...
            layouter(self._thumb)
                ...
                :Left(function()
                    return self.Left() +
                        (
                        (self._currentValue() - self._startValue) / (self._endValue - self._startValue) * self.Width()) -
                        self._thumb.Width() / 2
                end)
        end
    end,
...
ColoredIntegerSlider = ReUI.Core.Class(ColoredSlider)
{
    __init = function(self, parent,
                      isVertical,
                      startValue,
